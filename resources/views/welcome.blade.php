...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper" id="app">
        ...
        <!-- Main Sidebar Container -->
            <aside class="main-sidebar sidebar-dark-primary elevation-4" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forgot-password' ? false : true" id="sidebar" style="display: none">
                <!-- Brand Logo -->
